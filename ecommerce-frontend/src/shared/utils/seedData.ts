...
export const seedData = () => {
  ...
  const products: Product[] = [
    ...
    { id: 'mob-4', name: 'OnePlus 12', description: 'Smooth Beyond Belief. Snapdragon 8 Gen 3, 50MP Camera.', price: 64999, stock: 20, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-5', name: 'Xiaomi 13 Pro', description: 'Co-engineered with Leica. Professional-grade imaging.', price: 79999, stock: 10, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1565849904461-04a58ad377e0?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'mob-7', name: 'Nothing Phone (2)', description: 'Iconic Glyph interface. Unique design, powerful software.', price: 44999, stock: 25, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1592890288564-76628a30a657?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-8', name: 'Vivio X100 Pro', description: 'Zeiss optics everywhere. Master the camera.', price: 89999, stock: 7, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1580910051074-3eb694886505?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-9', name: 'Realme GT 5', description: 'Fast charging champion. 240W blazing power.', price: 35999, stock: 30, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-10', name: 'iQOO 12', description: 'Fast as logic. The gaming powerhouse.', price: 52999, stock: 12, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1565849904461-04a58ad377e0?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-11', name: 'iPhone 14 Pro', description: 'Dynamic Island. Always-on display. A magical new way to interact.', price: 119900, stock: 10, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1616348436168-de43ad0db179?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-12', name: 'Samsung Galaxy Z Fold 5', description: 'The ultimate foldable experience. Unfold your world.', price: 154999, stock: 5, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-13', name: 'Google Pixel 7a', description: 'Built to perform, priced just right.', price: 43999, stock: 20, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1616348436168-de43ad0db179?auto=format&fit=crop&q=80&w=800' },
    { id: 'mob-14', name: 'OnePlus Nord CE 3', description: 'Core Edition. Everything you need, nothing you don\'t.', price: 26999, stock: 35, category: 'Mobiles', imageUrl: 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'elec-4', name: 'ASUS ROG Zephyrus G14', description: 'The worlds most powerful 14" gaming laptop.', price: 149990, stock: 10, category: 'Electronics', imageUrl: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'elec-9', name: 'Western Digital 2TB SSD', description: 'High-speed storage. Fast and reliable portable SSD.', price: 14999, stock: 100, category: 'Electronics', imageUrl: 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'tv-2', name: 'Samsung 85" QN900C 8K', description: 'The pinnacle of Neo QLED. Extraordinary detail.', price: 699990, stock: 3, category: 'TVs & Appliances', imageUrl: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'tv-6', name: 'Samsung Front Load AI', description: 'Smart washing machine with Ecobubble technology.', price: 44990, stock: 20, category: 'TVs & Appliances', imageUrl: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'tv-9', name: 'Blue Star 1.5 Ton AC', description: 'Inverter split AC with high cooling performance.', price: 38990, stock: 15, category: 'TVs & Appliances', imageUrl: 'https://images.unsplash.com/photo-1574362848149-11496d93a7c7?auto=format&fit=crop&q=80&w=800' },
    { id: 'tv-10', name: 'Havells Instanio 3L', description: 'Instant water heater for your kitchen.', price: 3499, stock: 100, category: 'TVs & Appliances', imageUrl: 'https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'fas-3', name: 'Ray-Ban Wayfarer Classic', description: 'Original design with crystal green lenses.', price: 9290, stock: 40, category: 'Fashion', imageUrl: 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'fas-7', name: 'Tissot Gentleman Watch', description: 'Swiss-made elegance with sapphire crystal.', price: 35000, stock: 10, category: 'Fashion', imageUrl: 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'fas-9', name: 'Jack & Jones Chinos', description: 'Slim fit chinos in olive green.', price: 2499, stock: 85, category: 'Fashion', imageUrl: 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'bt-3', name: 'Barbie Dreamhouse', description: 'Full of furniture and fun features.', price: 19999, stock: 15, category: 'Beauty, Toys & More', imageUrl: 'https://images.unsplash.com/photo-1585366119957-e9730b6d0f60?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'bt-5', name: 'MAC Prep + Prime', description: 'Lightweight water mist that finishes makeup.', price: 2150, stock: 100, category: 'Beauty, Toys & More', imageUrl: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'bt-10', name: 'Nerf Elite 2.0 Commander', description: 'Customizable blaster with 12 darts.', price: 1499, stock: 60, category: 'Beauty, Toys & More', imageUrl: 'https://images.unsplash.com/photo-1585366119957-e9730b6d0f60?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'home-2', name: 'Sleepwell King Size Bed', description: 'Engineered wood with storage space.', price: 24900, stock: 10, category: 'Home & Furniture', imageUrl: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&q=80&w=800' },
    { id: 'home-3', name: 'Tupperware Heritage Set', description: 'Airtight containers for the kitchen.', price: 1499, stock: 200, category: 'Home & Furniture', imageUrl: 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?auto=format&fit=crop&q=80&w=800' },
    { id: 'home-4', name: 'Philips Hue Starter Kit', description: 'Smart lighting for your home.', price: 12999, stock: 45, category: 'Home & Furniture', imageUrl: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'home-6', name: 'Prestige Cookware Set', description: 'Non-stick induction base cookware.', price: 3499, stock: 100, category: 'Home & Furniture', imageUrl: 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?auto=format&fit=crop&q=80&w=800' },
    { id: 'home-7', name: 'Elica Filterless Chimney', description: 'Smart chimney with motion sensor.', price: 15490, stock: 12, category: 'Home & Furniture', imageUrl: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&q=80&w=800' },
    ...
    { id: 'groc-10', name: 'Colgate Strong Teeth', description: 'Protects against cavities and decay.', price: 129, stock: 300, category: 'Grocery', imageUrl: 'https://images.unsplash.com/photo-1610557892470-55d9e80c0bce?auto=format&fit=crop&q=80&w=800' },
  ].map(p => ({
    ...p,
  ...
  if (products.length > 0) {
    const seededIds = products.map(p => p.id);
    const userAddedProducts = existingProducts.filter((p: Product) => !seededIds.includes(p.id));
    const mergedProducts = [...products, ...userAddedProducts];
    localStorage.setItem('jesify_products', JSON.stringify(mergedProducts));
  }
